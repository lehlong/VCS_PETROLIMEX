...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    public class CompetitorController(ICompetitorService service) : ControllerBase
    {
        public readonly ICompetitorService _service = service;
        [HttpGet("Search")]
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] CompetitorDto Competitor)
        {
            var transferObject = new TransferObject();
            var result = await _service.Add(Competitor);
            if (_service.Status)
            {
                transferObject.Data = result;
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] CompetitorDto Competitor)
        {
            var transferObject = new TransferObject();
