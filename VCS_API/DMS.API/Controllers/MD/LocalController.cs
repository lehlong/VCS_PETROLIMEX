...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    public class LocalController(ILocalService service) : ControllerBase
    {
        public readonly ILocalService _service = service;
        [HttpGet("Search")]
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] LocalDto local)
        {
            var transferObject = new TransferObject();
            var result = await _service.Add(local);
            if (_service.Status)
            {
                transferObject.Data = result;
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] LocalDto local)
        {
            var transferObject = new TransferObject();
