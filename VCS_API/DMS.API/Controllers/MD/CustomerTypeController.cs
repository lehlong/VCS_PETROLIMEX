...
namespace DMS.API.Controllers.MD
{
    ...
    {
        public readonly ICustomerTypeService _service = service;
        [HttpGet("Search")]
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] CustomerTypeDto CustomerType)
        {
            var transferObject = new TransferObject();
            var result = await _service.Add(CustomerType);
            if (_service.Status)
            {
                transferObject.Data = result;
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] CustomerTypeDto CustomerType)
        {
            var transferObject = new TransferObject();
            await _service.Update(CustomerType);
            if (_service.Status)
            {
                transferObject.Status = true;
                transferObject.MessageObject.MessageType = MessageType.Success;
