...
namespace DMS.API.Controllers.MD
{
    ...
    [ApiController]
    public class LaiGopDieuTietController(ILaiGopDieuTietService service) : ControllerBase
    {
        public readonly ILaiGopDieuTietService _service = service;
        [HttpGet("Search")]
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] LaiGopDieuTietDto LaiGopDieuTiet)
        {
            var transferObject = new TransferObject();
            var result = await _service.Add(LaiGopDieuTiet);
            if (_service.Status)
            {
                transferObject.Data = result;
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] LaiGopDieuTietDto LaiGopDieuTiet)
        {
            var transferObject = new TransferObject();
            await _service.Update(LaiGopDieuTiet);
            if (_service.Status)
            {
                transferObject.Status = true;
                transferObject.MessageObject.MessageType = MessageType.Success;
