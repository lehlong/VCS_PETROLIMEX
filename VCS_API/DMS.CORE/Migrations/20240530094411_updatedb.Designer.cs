...
namespace DMS.CORE.Migrations
{
    ...
    [Migration("20240530094411_updatedb")]
            ...
            modelBuilder.Entity("DMS.CORE.Entities.AD.TblAdAccountGroupRight", b =>
                {
                    ...
                    b.ToTable("T_AD_ACCOUNTGROUP_RIGHT", t =>
                        {
                            t.Property("GROUP_ID")
                                .HasColumnName("GROUP_ID1");

                            t.Property("RIGHT_ID")
                                .HasColumnName("RIGHT_ID1");
                        });
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.AD.TblAdAccountRefreshToken", b =>
                {
                    ...
                    b.ToTable("T_AD_REFRESH_TOKEN", t =>
                        {
            ...
            modelBuilder.Entity("DMS.CORE.Entities.AD.TblAdAccountRight", b =>
                {
                    ...
                    b.ToTable("T_AD_ACCOUNT_RIGHT", t =>
                        {
                            t.Property("RIGHT_ID")
                                .HasColumnName("RIGHT_ID1");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.AD.TblAdAccount_AccountGroup", b =>
                {
                    ...
                    b.Property<Guid?>("TblAdAccountGroupId")
                        .HasColumnType("RAW(16)");
                    ...
                    b.HasIndex("TblAdAccountGroupId");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.TblMdDistrict", b =>
                {
                    ...
                    b.HasIndex("PROVINE_ID");

                    b.ToTable("T_MD_DISTRICT", t =>
                        {
                            t.Property("PROVINE_ID")
                                .HasColumnName("PROVINE_ID1");
                        });
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.TblMdVehicle", b =>
                {
                    ...
                    b.Property<int>("PARTNER_ID_CREATE")
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.Property<int>("VEHICLE_TYPE_CODE")
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.ToTable("T_MD_VEHICLE", t =>
                        {
                            t.Property("PARTNER_ID_CREATE")
                                .HasColumnName("PARTNER_ID_CREATE1");

                            t.Property("VEHICLE_TYPE_CODE")
                                .HasColumnName("VEHICLE_TYPE_CODE1");
                        });
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MD.TblMdWard", b =>
                {
                    ...
                    b.ToTable("T_MD_WARD", t =>
                        {
                            t.Property("DISTRICT_ID")
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MN.TblMnPartnerReference", b =>
                {
                    ...
                    b.Property<int>("PARTNER_ID_BUY")
                        .HasColumnType("NUMBER(10)");

                    b.Property<int>("PARTNER_ID_SELL")
                        .HasColumnType("NUMBER(10)");
                    ...
                    b.HasIndex("PARTNER_ID_BUY");

                    b.HasIndex("PARTNER_ID_SELL");

                    b.HasIndex("PartnerIdBuy", "PartnerIdSell")
                        .IsUnique();

                    b.ToTable("T_MN_PARTNER_REFERENCE", t =>
                        {
                            t.Property("PARTNER_ID_BUY")
                                .HasColumnName("PARTNER_ID_BUY1");

                            t.Property("PARTNER_ID_SELL")
                                .HasColumnName("PARTNER_ID_SELL1");
                        });
                });
            ...
            modelBuilder.Entity("DMS.CORE.Entities.AD.TblAdAccount_AccountGroup", b =>
                {
                    ...
                    b.HasOne("DMS.CORE.Entities.AD.TblAdAccountGroup", null)
                        .WithMany("Account_AccountGroups")
                        .HasForeignKey("TblAdAccountGroupId");
            ...
            modelBuilder.Entity("DMS.CORE.Entities.MN.TblMnPartnerReference", b =>
                {
                    b.HasOne("DMS.CORE.Entities.MD.TblMdPartner", "PartnerBuy")
                        .WithMany()
                        .HasForeignKey("PARTNER_ID_BUY")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DMS.CORE.Entities.MD.TblMdPartner", "PartnerSell")
                        .WithMany()
                        .HasForeignKey("PARTNER_ID_SELL")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
